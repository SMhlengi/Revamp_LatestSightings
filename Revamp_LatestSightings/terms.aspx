...
<asp:PlaceHolder ID="tnc" runat="server"></asp:PlaceHolder>
...
<!-- Page Content Area -->
	...
	<div class="row">
		...
		<div class="leftcol">
            ...
            <!-- Blog BEGIN -->
            <h1 class="main-title" style="margin-top:0px !important;"><%= termsAndConditions["header"] %></h1>
...
<%--                <div class="blog-list-featured-image">
                ...
                <div class="blog-list-content">
                    ...
                    <div style="color:white">
                        <%= termsAndConditions["body"].Replace("color: #111111;", "").Replace("color: #333333;", "").Replace("color: #444444;", "") %>
                    </div>
